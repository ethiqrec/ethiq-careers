...
import { fetchActiveRoles, fetchRoleDetail, transformRole, fetchPublicLocations } from './atlas.js'
import { getCachedRoles, setCachedRoles } from './cache.js'
import { readFileSync } from 'fs'
import { join } from 'path'

// Location data is now fetched from Atlas Public Jobs GraphQL API
...
export async function getRoles() {
  ...
  // Fetch location data from Atlas Public Jobs API
